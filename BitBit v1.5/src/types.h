...
const std::string engineVersion = "1.5";
...
constexpr Score
  ...
  SCORE_TB_WIN = SCORE_MATE_IN_MAX_PLY - 1, 
...
constexpr CastlingData CASTLING_DATA[9] = {
    {},
    {SQ_E1, SQ_G1, SQ_H1, SQ_F1},
    {SQ_E1, SQ_C1, SQ_A1, SQ_D1}, 
    {},
    {SQ_E8, SQ_G8, SQ_H8, SQ_F8}, 
    {}, {}, {},
    {SQ_E8, SQ_C8, SQ_A8, SQ_D8} 
};
